...
echo_and_run cd "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/samnehme/Dev/armstrong/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
