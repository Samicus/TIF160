...
echo_and_run cd "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/samnehme/Dev/armstrong/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
