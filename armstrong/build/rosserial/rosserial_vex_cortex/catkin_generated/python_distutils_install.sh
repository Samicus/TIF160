...
echo_and_run cd "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/samnehme/Dev/armstrong/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/samnehme/Dev/armstrong/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
